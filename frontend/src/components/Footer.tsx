      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="mb-3 flex items-center gap-2">
              <img src="/Logo.png" alt="The Hearth Project" className="h-8 w-auto" />
              <span className="text-lg font-bold text-white">The Hearth Project</span>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              {quickLinks.map(({ to, label }) => (
                <Link key={to} to={to} className="text-sm text-gray-400 no-underline transition hover:text-orange-500">{label}</Link>
              ))}
            </div>
          </div>
          ...
          {/* Get Involved */}
          <div>
            <h4 className="mb-4 text-sm font-semibold uppercase tracking-wider text-white">Get Involved</h4>
            <div className="flex flex-col gap-2.5">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              <Link to="/contact" className="text-sm text-gray-400 no-underline transition hover:text-orange-500">Contact Us</Link>
              <Link to="/privacy" className="text-sm text-gray-400 no-underline transition hover:text-orange-500">Privacy Policy</Link>
              <Link to="/terms" className="text-sm text-gray-400 no-underline transition hover:text-orange-500">Terms of Service</Link>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex gap-6">
            <Link to="/privacy" className="text-xs text-gray-500 no-underline transition hover:text-orange-500">Privacy</Link>
            <Link to="/terms" className="text-xs text-gray-500 no-underline transition hover:text-orange-500">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
